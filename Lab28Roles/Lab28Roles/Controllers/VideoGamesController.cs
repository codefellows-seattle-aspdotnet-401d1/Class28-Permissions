...
namespace Lab28Roles.Controllers
{
    public class VideoGamesController : Controller
    {
        ...
        public VideoGamesController(Lab28RolesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,Description,Rating,IsReleased")] VideoGames videoGames)
        {
